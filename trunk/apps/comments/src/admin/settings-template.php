                ...
                <div id="fyreimportstatus">
                    ...
                    ?>
                        ...
                        <div id="import_toggle_button" cursor="pointer">
                            <img id="import_toggle" src="<?php echo LF_PLUGIN_URL . '/images/more-info.png'; ?>" rel="Info">
                    ...
                    ?>
                        ...
                        <div id="gears">
                            <img src="<?php echo LF_PLUGIN_URL . '/images/gear1.png';?>" class="gear1" alt="" />
                            <img src="<?php echo LF_PLUGIN_URL . '/images/gear2.png';?>" class="gear2" alt="" />
                            <img src="<?php echo LF_PLUGIN_URL . '/images/gear3.png';?>" class="gear3" alt="" />
                        </div>
...
<style>
    <?php wp_enqueue_style("livefyre-css", LF_PLUGIN_URL . '/src/admin/settings-template.css' );  ?>
</style>
